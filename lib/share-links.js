...
// utm_source   = платформата (instagram, tiktok, facebook...)
// utm_medium   = "influencer_portal" (фиксиран)
// utm_campaign = промо кода (ANI5, KALI5...)
export function buildShopifyDiscountUrl(promoCode, platform, redirectPath) {
  ...
  const pathWithUtm = addUtm(path, {
    source:   normalizePlatform(platform),
    medium:   'influencer_portal',
    campaign: promoCode,
  })

...
//   customerEmail    — за билинг информация
//   tags             — масив от тагове (или string)
//   shippingAddress  — { first_name, last_name, address1, phone, country, country_code, ... }
//   markPaid         — true ако сумата за плащане е 0 (изцяло безплатна) → добавя $0 транзакция
...
export async function createOrder({
  ...
  const body = {
    order: {
      ...
      // За напълно безплатни поръчки маркираме като платена с 0-сума транзакция
      ...(markPaid ? {
